    ...
    n.InputPhone = function () {
        ...
        function t(n) {
            ...
            (this.$phone = t.find("input[type=tel]")),
                ...
                this.$phone_region.on(
                    "change",
                    this._handleChangePhoneRegion.bind(this)
                ),
                (r = this),
                i
                    ? this._initSelect2()
                    : $.ajax({
                        ...
                        dataType: "json",
                        success: function (n) {
                            (i = n.regions), r._initSelect2();
                        },
                    });
        }

        var r = "ZZ",
            o = libphonenumber.PhoneNumberFormat.E164,
...
$(function() {
        ...
        var n = {
            ...
            handleCheckoutChange: function(t) {
                ...
                this.customerAddress && ["billingName", "billingAddress", "billingPhone", "billingProvince", "billingDistrict", "billingWard", "billingZip"].indexOf(r.name) >= 0 && (this.customerAddress = 0)
            },
            ...
            applyReductionCode: function() {
                var r = document.forms.checkoutForm,
                    ...
                    t, i;
                this.differenceAddress ? n.push("shippingProvince", "shippingDistrict", "shippingWard") : n.push("city", "district", "ward");
            ...
            refreshShippingMethod: function(n) {
                ...
                this.differenceAddress ? t.push("shippingProvince", "shippingDistrict", "shippingWard") : t.push("city", "district", "ward");
                r = {
